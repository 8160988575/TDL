...
<div class="toolbar">
    ...
    <button type="button" id="groupSearchButton" class="filter-search-btn">🔎 Search</button>
...
(function () {
    ...
    /*
     * Read exactly what the user sees in the grid.
     * data-search is included as a fallback for hidden/searchable values.
     */
     ...
     *
     * means:
     *   tarun must occur somewhere
     *   patel must occur somewhere
     *
     * Thus:
     *   Tarunkumar Jaysukhbhai Patel
     * is found.
     */
    ...
    /*
     * Remove only our own highlighting.
     */
    function clearHighlight() {
        var marks =
            document.querySelectorAll(
                "#groupsTable .tdl-highlight"
            );
    ...
    /*
     * Highlight actual visible text.
     *
     * IMPORTANT:
     * We do NOT use TreeWalker filters or complicated DOM logic here.
     * We simply process text nodes in each TD.
     */
    function highlightRow(row, query) {
        ...
        /*
         * Collect first, modify second.
         * This is important because modifying a live TreeWalker
         * while walking it can skip nodes.
         */
        var walker =
        ...
        while ((node = walker.nextNode())) {
            ...
            if (
                parent.closest(
                    "button,input,textarea,select,option,script,style,.tdl-highlight"
                )
            ) {
                continue;
            }
    ...
    function init() {
        ...
        /*
         * ENTER — prevent GET form submission.
         */
        input.addEventListener(
            "keydown",
            function (event) {
