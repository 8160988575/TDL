...
.filters{display:grid;grid-template-columns:minmax(220px,1fr) 170px 135px 135px 135px 135px 80px;gap:9px}
...
.filters{grid-template-columns:minmax(180px,1fr) 135px 120px 120px 120px 75px}
...
.filter-toggle span{display:flex;align-items:center;gap:5px;white-space:nowrap}
.filter-toggle input:checked+span{
    color:#fff;
    background:linear-gradient(135deg,#092846,#205f8f);
    border-radius:7px;
    padding:8px 10px;
}
.star-filter input:checked+span{
    background:linear-gradient(135deg,#a97819,#d5a53d);
}
.star-btn{
    min-width:88px;
    height:36px;
...
<a href="groups_directory.php" class="panel">Group Directory</a>
...
<input class="auto-filter" type="checkbox" name="confirmed" value="1" <?= $confirmed_filter ? 'checked' : '' ?>>
<span>✓ Confirmed</span>
</label>

<label class="filter-toggle">
<input class="auto-filter" type="checkbox" name="imp" value="1" <?= $imp_filter ? 'checked' : '' ?>>
<span>★ Important</span>
</label>

<label class="filter-toggle star-filter">
<input class="auto-filter" type="checkbox" name="starred" value="1" <?= $star_filter ? 'checked' : '' ?>>
...
(function(){
    ...
    filterForm.querySelectorAll('.auto-filter').forEach(function(input){
